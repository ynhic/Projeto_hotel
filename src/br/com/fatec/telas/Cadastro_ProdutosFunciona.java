...
public class Cadastro_ProdutosFunciona extends javax.swing.JFrame {
...
//Cria/Exibe o form Estoque
    public Cadastro_ProdutosFunciona() {
        initComponents();
    }
...
//------------ Metodos ------------
    ...
    private void preencheTable() 
    {
        ...
        {
            Logger.getLogger(Cadastro_ProdutosFunciona.class.getName()).log(Level.SEVERE, null, ex);
        }
        tbProdutos.setModel(tableModelProduto);
...
//------------ Botoes do form ------------        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_ProdutosFunciona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastro_ProdutosFunciona().setVisible(true);
            }
        });
    }
